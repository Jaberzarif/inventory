...
if(isset($_POST["submit"]))
{
    ...
    {
        $error .= '<li>Business Name is required</li>';
    }
    else
    {
    ...
    {
        $error .= '<li>Business Address is required</li>';
    }
    else
    {
    ...
    {
        $error .= '<li>Business Contact No. is required</li>';
    }
    else
    {
    ...
    {
        $error .= '<li>Business Email Address is required</li>';
    }
    else
    {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Set Up</h3></div>
                                    <div class="card-body">
                                        <?php
                                        if($error != '')
                                        {
                                        ...
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="store_name">Business Name</label>
                                            </div>
                                            <div class="form-floating mb-3">
